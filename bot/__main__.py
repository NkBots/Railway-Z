...
def stats(update, context):
    ...
    stats = f'<b><i><u>⇅ 𝗕𝗼𝘁 𝗦𝘁𝗮𝘁𝗶𝘀𝘁𝗶𝗰𝘀 ⇅</u></i></b>\n\n'\
...
def start(update, context):
    if config_dict['DM_MODE']:
        start_string = 'Welcome ●✤◄ 𝐖𝐃 𝐙𝐎𝐍𝐄  ►✤● is online now 😈 | Use @Opleech for mirror games 💚.\n' \
        ...
        start_string = '🦋 Hey, Welcome dear. \n' \
                       ...
                       'Created With Love by @Opleech . \n' \
                       '𝐀ɴɢᴇʟ x 𝐎ᴘ LOL 🦋 Thank You!'
